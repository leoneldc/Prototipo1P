...
public class Mnt_Productos extends javax.swing.JInternalFrame {
    ...
    private void limpiar() {
        procesosr.limpiarTxf(Txt_id, Txt_nombre, Txt_marca, Txt_existencia, Txt_busqueda);
    ...
    private void initComponents() {
        ...
        Txt_marca.setBackground(new java.awt.Color(253, 248, 225));
        ...
        Lbl_user.setText("EXISTENCIAS:");

        Txt_existencia.setBackground(new java.awt.Color(253, 248, 225));
        Txt_existencia.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        Txt_existencia.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(88, 129, 87)));
        Txt_existencia.setDoubleBuffered(true);
            ...
            .addGroup(Pnl_ingresoDatosLayout.createSequentialGroup()
                ...
                .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Pnl_ingresoDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(Txt_existencia, javax.swing.GroupLayout.Alignment.TRAILING)))
    ...
    private void Tbl_DatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tbl_DatosMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            Txt_existencia.setText(Tbl_Datos.getValueAt(Tbl_Datos.getSelectedRow(), 3).toString());
    ...
    private void Btn_modificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_modificarMouseClicked
        if (procesosr.isEmptyTxf(Txt_nombre, Txt_marca, Txt_existencia)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.isSelectedRbt(Rb_activo, Rb_inactivo)) {
                    ...
                    usuarios.setMarca(Txt_marca.getText());
                    usuarios.setExistencia(Txt_existencia.getText());
                    ...
                    cargarDatos("");
                    procesosr.accionExitosa("Modificación Exitosa", "Se ha modificado el producto: \"" + Txt_nombre.getText() + " " + Txt_marca.getText() + "\" correctamente");
                    limpiar();
                }
            }
        }
    ...
    private void Btn_eliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn_eliminarMouseClicked
        if (procesosr.isEmptyTxf(Txt_id)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.confirmarEliminación("el producto # " + Txt_id.getText())) {
                    usuarios.setId(Txt_id.getText());
        ...
        if (procesosr.isEmptyTxf(Txt_nombre, Txt_marca, Txt_existencia)) {
            if (procesosr.isNumeric(Txt_id)) {
                if (procesosr.isSelectedRbt(Rb_activo, Rb_inactivo)) {
                    ...
                    cargarDatos("");
                    procesosr.accionExitosa("Registro Exitoso", "Se ha registrado el producto: \"" + Txt_nombre.getText() + " " + Txt_marca.getText() + "\" correctamente");
                    limpiar();
                }
            }
        }
